<script>
    ...
    onMount( async () => {
        ...
        const response = await fetch(BASE_URL+"products/s2s_oct_24");
    ...
    // forsøg med en anden type af items og om det kan vises


    // const items = [
    //   { model_number: 23, model_name: 'kajka', kon: 'woman', farvekode: 228, felt3: 3, felt4: 4 }
    // ]
